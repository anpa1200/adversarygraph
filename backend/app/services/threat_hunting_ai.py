...
async def complete(adapter, system: str, user: str) -> str:
    ...
    # A 45-second legacy setting is too short for CPU-hosted local 8B models
    # producing validated JSON over retrieved context. Preserve operator
    # control above this floor while keeping the adapter's hard ceiling.
