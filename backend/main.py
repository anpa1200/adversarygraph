...
import app.models.pcap as _pcap_models  # noqa: F401 — register Base metadata
from app.api.routes import asset_surface, attack, apt, analyze, auth, sync, export, ioc, cve, emb3d, evidence_graph, layers, malwaregraph, observability, operations, pcap, pipeline, query_library, rag, report_review, research, retrohunt, sector, simulation, statistics, system, knowledge, troubleshooting, threat_hunting, threat_hunting_ai, threat_radar
...
app.include_router(pcap.router, prefix="/api", dependencies=_one_module_required("ai_analysis", "investigation"))
