...
[![Release](https://img.shields.io/badge/release-v5.2.0-blue)](VERSION)
...
Current release: **v5.2.0**. See the [version matrix](docs/version-matrix.md), [v5.0 release summary](docs/release-summary-v5.0.0.md), and [published v5 article](https://medium.com/@1200km/adversarygraph-v5-0-from-cti-mapping-to-attack-simulation-and-siem-validation-21873b2a6c39).
