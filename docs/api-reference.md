...
| `POST` | `/api/ioc/report` | Preview Iocs From Report | 200 |
...
| `PATCH` | `/api/operations/investigations/{item_id}/marking` | Mark Investigation | 200 |
...
| `GET` | `/api/operations/investigations/{item_id}/summary/preflight` | Summary Preflight | 200 |
...
| Method | Path | Operation | Success |
|---|---|---|---|
| `GET` | `/api/analyze/sessions/{session_id}/review` | Get Report Review | 200 |
| `POST` | `/api/analyze/sessions/{session_id}/review/ai-assist` | Assist Report Review | 200 |
| `POST` | `/api/analyze/sessions/{session_id}/review/approve` | Approve Report Review | 200 |
| `POST` | `/api/analyze/sessions/{session_id}/review/claims` | Create Report Review Claim | 200 |
| `PATCH` | `/api/analyze/sessions/{session_id}/review/claims/{claim_id}` | Record Claim Decision | 200 |
| `POST` | `/api/analyze/sessions/{session_id}/review/coverage-exception` | Grant Report Review Coverage Exception | 200 |
| `PATCH` | `/api/analyze/sessions/{session_id}/review/gates/{gate_key}` | Record Gate Decision | 200 |
| `GET` | `/api/analyze/sessions/{session_id}/review/history` | Get Report Review History | 200 |
| `POST` | `/api/analyze/sessions/{session_id}/review/preflight` | Run Report Review Preflight | 200 |
| `POST` | `/api/analyze/sessions/{session_id}/review/promote` | Promote Report Review | 200 |
| `GET` | `/api/analyze/sessions/{session_id}/review/promotion` | Get Active Report Promotion | 200 |
| `POST` | `/api/analyze/sessions/{session_id}/review/reject` | Reject Report Review | 200 |
| `POST` | `/api/analyze/sessions/{session_id}/review/request-changes` | Request Report Review Changes | 200 |
| `POST` | `/api/analyze/sessions/{session_id}/review/revoke` | Revoke Report Promotion | 200 |
| `POST` | `/api/analyze/sessions/{session_id}/review/start` | Start Report Review | 200 |
| `POST` | `/api/analyze/sessions/{session_id}/review/submit` | Submit Report Review | 200 |
...
| Method | Path | Operation | Success |
|---|---|---|---|
| `GET` | `/api/research/projects` | List revisioned research projects | 200 |
| `POST` | `/api/research/projects` | Create a research project and revision one | 201 |
| `GET` | `/api/research/projects/{project_id}` | Get a research project and current revision | 200 |
| `PATCH` | `/api/research/projects/{project_id}` | Update research project metadata | 200 |
| `POST` | `/api/research/projects/{project_id}/archive` | Archive a research project | 200 |
| `GET` | `/api/research/projects/{project_id}/revisions` | List immutable project revisions | 200 |
| `POST` | `/api/research/projects/{project_id}/revisions` | Create the next immutable project revision | 201 |
| `GET` | `/api/research/projects/{project_id}/revisions/{revision_number}` | Get one immutable project revision | 200 |
| `GET` | `/api/research/projects/{project_id}/workflows` | List durable workflows for a research project | 200 |
| `POST` | `/api/research/projects/{project_id}/workflows` | Start or replay the canonical research-scope workflow | 201 |
| `GET` | `/api/research/projects/{project_id}/workflows/{workflow_run_id}` | Get durable workflow and ordered stage status | 200 |
| `POST` | `/api/research/projects/{project_id}/workflows/{workflow_run_id}/cancel` | Cancel a durable research workflow with an idempotent command | 200 |
