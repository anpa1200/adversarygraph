...
`1920x1200` with Chromium and sanitized deterministic API fixtures.

The images demonstrate current UI rendering and documented controls. They do
not prove a live external feed, successful exploit, customer deployment, or
real-world detection. Fixture values use fictional records and approved lab
targets; no credentials, private reports, customer data, or malware are
included.
...
|---|---|---|
| `01-discover-workspace.png` | Discover | Current module navigation and workflow launchers spanning intelligence, asset, simulation, evidence, and malware analysis |
