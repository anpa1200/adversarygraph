...
1. [Usecase number "1" - Check One IOC](./01-simple-check-an-ioc.md)
2. [Usecase number "2" - Open One Actor Profile](./02-simple-open-actor-profile.md)
3. [Usecase number "3" - Show Actor TTPs On The Matrix](./03-simple-show-actor-on-matrix.md)
4. [Usecase number "4" - Search The IOC Library](./04-simple-search-ioc-library.md)
5. [Usecase number "5" - Sync ThreatFox IOCs](./05-simple-sync-threatfox.md)
6. [Usecase number "6" - Import A Navigator Layer](./06-simple-import-navigator-layer.md)
7. [Usecase number "7" - Export A PDF Report](./07-simple-export-pdf-report.md)
8. [Usecase number "8" - Run Deployment Selftest](./08-simple-run-selftest.md)
9. [Usecase number "9" - Add A Custom IOC Feed](./09-simple-add-custom-ioc-feed.md)
10. [Usecase number "10" - Open Troubleshooting For An Error](./10-simple-open-troubleshooting.md)

## Intermediate Usecases

11. [Usecase number "11" - Map A Report To ATT&CK](./11-intermediate-map-report-to-attack.md)
12. [Usecase number "12" - Compare Incident TTPs To Actors](./12-intermediate-compare-incident-to-actors.md)
13. [Usecase number "13" - Build A Sector Threat Brief](./13-intermediate-build-sector-brief.md)
...
25. [Usecase number "25" - Investigation: Validate A Third-Party CTI Report](./25-investigation-third-party-report-validation.md)

## Complex Defense Usecases

26. [Usecase number "26" - Defense: Build MITRE Coverage Baseline](./26-defense-mitre-coverage-baseline.md)
27. [Usecase number "27" - Defense: Create Sector-Based Detection Roadmap](./27-defense-sector-detection-roadmap.md)
